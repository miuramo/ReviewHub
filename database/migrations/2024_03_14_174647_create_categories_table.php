...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->integer('pdf_page_min')->default(2)->comment("PDFページ数下限");
            $table->integer('pdf_page_max')->default(50)->comment("PDFページ数上限");
            ...
            $table->integer('accept_video')->default(0)->comment("0は不可 1は必須 2はオプション");
            $table->integer('accept_img')->default(0)->comment("0は不可 1は必須 2はオプション");
            ...
            $table->integer('accept_altpdf')->default(0)->comment("0は不可 1は必須 2はオプション");
            $table->integer('altpdf_page_min')->default(1);
            $table->integer('altpdf_page_max')->default(1);

            $table->string('openstart', 10)->default('01-01')->comment("新規投稿受入開始日");
            $table->string('openend', 10)->default('12-31')->comment("新規投稿受入最終日");
            $table->timestamps();
        });
    }
