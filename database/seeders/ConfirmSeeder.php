...
class ConfirmSeeder extends Seeder
{
    ...
    {
        $kakunin = [
            "chk1" => "下のボタンで新規投稿情報を作成→ファイルアップロード→受領メール送信を押していただくと、投稿申込完了となります。",
            "chk2" => "投稿状況の確認や投稿の修正は「投稿一覧」から行います。",
        ];
        foreach ($kakunin as $nm => $mes) {
            Confirm::factory()->create([
                'name' => $nm,
                'mes' => $mes,
                'grp' => 1,
            ]);
        ...
        $mailkakunin = [
            ...
            "chk7" => "投稿連絡用メールアドレスは投稿完了後も追加・修正できます。ただし新規に追加されたアドレスへ、過去の通知を再送信することはありません。また投稿に紐づけられた共著者は投稿情報の参照はできますが、ファイルの差し替えや入力情報の修正はできません。これらのシステムの動作について、了解しました。",
