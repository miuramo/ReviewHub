    ...
    <form action="{{ route('paper.update_authorlist', ['paper' => $paper]) }}" method="post" id="authorlist">
        ...
        <div class="mx-4 mb-1">
            ...
            <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-2">
                <div class="p-0">
                    <div class="text-sm px-2  dark:text-gray-400">和文著者名(所属)</div>
                ...
                <div class="p-0">
                    <div class="text-sm px-2  dark:text-gray-400">和文著者名(所属) サンプル</div>
                ...
                <div class="p-0">
                    <div class="text-sm px-2  dark:text-gray-400">英文著者名(所属)（姓→名の順で記す場合は、姓のあとに, (カンマ)を入れることが多いです。）</div>
                ...
                <div class="p-0">
                    <div class="text-sm px-2  dark:text-gray-400">英文著者名(所属) サンプル</div>
