...
class StoreFileRequest extends FormRequest
{
    ...
    public function storeFile(): object
    {
        ...
        $file->save();
        // $hashname = sprintf(env('PID_FORMAT','%04d'), $this->input("paper_id"))."_".Auth::user()->id."_".$tmp->hashName();
        $hashname = sprintf(env('PID_FORMAT','%04d'), $this->input("paper_id")) . "_" . $file->id . "_" . $tmp->hashName();
