...
trait GetValueTrait
{
    ...
    public static function getValue(object|string $id, $dummy = null): ?string
    {
        $obj = self::findByIdOrName($id);
    ...
    public static function getval(object|string $id, $dummy = null): ?string
    {
        return self::getValue($id, $dummy);
    }
