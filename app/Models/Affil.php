...
class Affil extends Model
{
     ...
     * すべて再構築
     */
    public static function rebuild(int $border_score = 100): void
    {
        Affil::truncate();
     ...
     * 書誌情報の著者所属を、抽出する
     */
    public static function distill(int $border_score = 100): void
    {
        // Affil::truncate();
    ...
    public static function after_kouho(string $str): string
    {
        ...
        //     // 「大学大学院」は「大学大学院」で全体を残す
        //     $str = mb_substr($str, 0, $matches[0][1] + mb_strlen('大学大学院'));
        //     return $str;
        // }
        // // 「大学」が含まれる場合、「大学」まで残す
        // elseif (preg_match('|大学|u', $str, $matches, PREG_OFFSET_CAPTURE)) {
        //     $str = mb_substr($str, 0, $matches[0][1] + mb_strlen('大学'));
        //     return $str;
        // }
