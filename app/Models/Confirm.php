...
class Confirm extends Model
{
    ...
    public static function seeder_policy(): void
    {
        Confirm::firstOrCreate(
            ...
            [
                "mes" => "本投稿システムでは、投稿管理の都合上、入力された情報（論文PDFや画像など）を加工したり、情報を抽出することがあります。"
        ...
        Confirm::firstOrCreate(
            ...
            [
                "mes" => "入力された情報およびそれらを投稿システムが加工した情報は基本的に本論文誌編集・出版目的のみ利用します。"
                    . "ただし、本論文誌を出版する学会や編集委員会が判断した場合は、その他の学会運営業務に用いることがあります。",
                "valid" => true,
            ]
        );
        Confirm::firstOrCreate(
        ...
        Confirm::firstOrCreate(
            ...
            [
                "mes" => "投稿する論文PDFおよび含まれる図や画像等については、第三者の著作権を侵害しないよう注意してください。"
